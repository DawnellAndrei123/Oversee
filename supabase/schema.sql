...
comment on table public.oversee_app_data is 'Per-account Oversee application data such as projects, SWA, estimates, templates, and material price lists.';
comment on table public.oversee_gathered_app_data is 'Readable per-account Oversee app data snapshots with the email and full name of the user who saved the data.';
